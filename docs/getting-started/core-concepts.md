...
<aside class="notifications note">
  ...
  <p>If instead you want to get started right away, you can check out the <a href="#/./ioFog_3.0quick-start-local">Quick Start guide</a> to deploy ioFog locally on your computer, or go through production deployment in <a href="#/./ioFog_3.0/platform-deployment/introduction">Remote deployment</a> or <a href="#/./ioFog_3.0/platform-deployment/kubernetes-prepare-cluster">Kubernetes deployment</a>.</p>
