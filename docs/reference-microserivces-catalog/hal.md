...
> You can use the `rootHostAccess` field of the [microservice yaml definition](../reference-potctl/reference-application) to grant root access to the host to your container
