...
<aside class="notifications note">
  ...
  <p>Under the hood, the SDK uses the <a href="..//reference-agent/rest-api">Agent Local API</a> which, while more low-level, is considered a public API you can call directly too.</p>
